...
const Regitser = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (name && email && password1 && password1 === password2) {
      ...
      alert("Veuillez remplir les champs comme requis");
    }
  };
      ...
      <main className="w-full flex">
            <div className="relative flex-1 hidden items-center justify-center h-screen bg-gray-900 lg:flex">
                ...
                <div
                    ...
                    style={{
                        backgroundImage: "url(https://insanelygoodrecipes.com/wp-content/uploads/2020/09/Croissant-Fillings-1.jpg)",    backgroundSize: "cover" ,  width: "100%",
    height: "100%",
                    }}
                >
                ...
                <div className="w-full max-w-md space-y-8 px-4 bg-white text-gray-600 sm:px-0">
                    <div className="">
                        ...
                        <div className="mt-5 space-y-2">
                            ...
                            <p className="">Arelady have an account? <Link to="/Login"><a  className="font-medium text-indigo-600 hover:text-indigo-500">Login</a></Link></p>
                        </div>
                    </div>
